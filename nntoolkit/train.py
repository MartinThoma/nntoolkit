...
def minibatch_gradient_descent(model_file,
    ...
    :param training_data: Path to a data.tar
...
def main(model_file, training_data):
    minibatch_gradient_descent(model_file, training_data)

if __name__ == '__main__':
    args = get_parser().parse_args()
    main(args.model_file, args.training_data)
